		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#corsobtpfioriproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"corsobtpfioriproject-display": {
								"semanticObject": "corsobtpfioriproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=corsobtp.fioriproject",
									"url": sap.ui.require.toUrl("corsobtp/fioriproject")
								}
							}
						}
					}
